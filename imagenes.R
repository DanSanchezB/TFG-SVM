...
grafica_hiperplano = ggplot(datos1, aes(x = X1, y = X2, color = Clase)) +
  ...
  theme(legend.position = "none",
        ...
        panel.grid.minor = element_blank()) #para que la cuadrícula no sea tan fina

print(grafica_hiperplano)

#ggsave("hiperplano_discriminante.png", plot = grafica_hiperplano, width = 6, height = 4.5, units = "in")
...
grafica_max_margen = ggplot() +
  ...
  geom_ribbon(data = datos2_sombreado, aes(x = X1, ymin = Y_inf, ymax = Y_mid), 
              fill = "royalblue", alpha = 0.12) +
  geom_ribbon(data = datos2_sombreado, aes(x = X1, ymin = Y_mid, ymax = Y_sup), 
              fill = "red", alpha = 0.12) +
  #sombreado suave entre el margen y el hiperplano
  
  scale_color_manual(values = c("G1" = "red", "G2" = "royalblue")) +
  geom_segment(data = sv, aes(x = X1, y = X2, xend = x_end, yend = y_end), 
...
print(grafica_max_margen)

#ggsave("max_margen2.png", plot = grafica_max_margen, width = 6, height = 4.5, units = "in")
...
print(grafica_no_separable)

ggsave("no_separable.png", plot = grafica_no_separable, width = 6, height = 4.5, units = "in")
...
ggsave("sensibilidad_izq.png", plot = grafica_izq, width = 4, height = 4)
ggsave("sensibilidad_der.png", plot = grafica_der, width = 4, height = 4)
...
print(grafica_ancho)
print(grafica_estrecho)

ggsave("margen_ancho.png", plot = grafica_ancho, width = 4, height = 4)
ggsave("margen_estrecho.png", plot = grafica_estrecho, width = 4, height = 4)
...
#ggsave("klineal.png", plot = grafica_lin, width = 4, height = 4)


##kernel polinomico----

modelo_polinomico = svm(Clase ~ ., data = datos6, kernel = "polynomial", degree = 2, 
                        cost = 10, coef0 = 1, decision.values = TRUE) 
#para el radial quitamos degree y ponemos gamma

resolucion = 0.05
grid = expand.grid(X1 = seq(0, 7, by = resolucion), 
...
grafica_polinomico = ggplot() +
  ...
  geom_point(data = sv_polinomico, aes(x = X1, y = X2), 
...
print(grafica_polinomico)
#ggsave("kpolinomico.png", plot = grafica_polinomico, width = 4, height = 4)
...
modelo_gaussiano = svm(Clase ~ ., data = datos6, kernel = "radial", gamma = 0.3, 
                 cost = 10, coef0 = 1, decision.values = TRUE) 
...
grafica_gaussiano = ggplot() +
  ...
  #resaltamos los vectores de soporte
  geom_point(data = sv_gaussiano, aes(x = X1, y = X2), 
             color = "black", size = 3, shape = 1, stroke = 1) +
...
print(grafica_gaussiano)
#ggsave("kgaussiano.png", plot = grafica_gaussiano, width = 4, height = 4)
...
print(grafica_hingeloss)

ggsave("hingeloss.png", plot = grafica_hingeloss, width = 6, height = 4)
...
modelo_svr = svm(Y ~ X, data = datos7, kernel = "linear", 
                 cost = 10, epsilon = epsilon_val, scale = FALSE) #incluimos epsilon
...
#ggsave("tubo_svr.png", plot = grafica_svr, width = 8, height = 4)
