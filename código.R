...
summary(param_breast_polinomico) #tomamos c = 1, grado = 2 en vez de grado 4 
#porque solo aumenta en 0.005 el error y la dispersion y es mucho más simple
...
summary(param_abalone_lineal) #aunque gana la fila 20, la fila 19 no sube tanto 
#el error (solo 0.002) ni la dispersión, además es más simple por tener menor coste
#NOS QUEDAMOS CON C = 10, epsilon = 0.5 (fila 19)
